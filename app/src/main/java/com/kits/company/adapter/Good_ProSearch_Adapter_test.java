...
public class Good_ProSearch_Adapter_test extends RecyclerView.Adapter<Good_ProSearch_Adapter_test.GoodViewHolder>{
    ...
    public Good_ProSearch_Adapter_test(List<Good> goods, Context mContext)
    {
    ...
    {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.good_prosearch_test, parent, false);
